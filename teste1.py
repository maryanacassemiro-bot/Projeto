...
# Título do app
st.title("📊 Análise de Emoções e Nuvem de Palavras - Discurso de Posse")

# Upload do arquivo PDF
uploaded_file = st.file_uploader("📁 Faça upload do arquivo PDF do discurso", type=["pdf"])
...
if uploaded_file:
    ...
    # Análise de emoções
    st.subheader("📈 Análise de Emoções no Discurso")
    ...
    st.write("### Probabilidades das Emoções")
    ...
    ax.set_title(f"Análise de Emoções - {nome_presidente}", fontsize=16, fontweight='bold')
